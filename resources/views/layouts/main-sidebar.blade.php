        ...
        <div class="side-menu-fixed">
            <div class="scrollbar side-menu-bg">
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <!-- menu item stages-->
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#stages-menu">
                            <div class="pull-left"><i class="ti-calendar"></i><span
                                    class="right-nav-text">{{trans('main_sidebar.stages')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="stages-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('stages.index')}}">{{trans('main_sidebar.stageslist')}}</a> </li>
                        </ul>
                    </li>
                    <!-- menu item todo-->
                    <li>
